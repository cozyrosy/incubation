...
export default function Approved() {
    const [approvs, setApprove] = useState([]) 
    const { authTokens } = useContext(AuthContext);
    useEffect(()=> {
        Axios.get('http://127.0.0.1:8000/base/approvedlist', 
        {
    ...
    return (
        ...
        <div className="flex flex-col">
            <h1 className="font-bold text-4xl text-gray-600 text-center">Approved Applications</h1 >
            <div className="overflow-x-auto">
                ...
                <div className="p-1.5 w-full inline-block align-middle">
                    <div className="overflow-hidden table-auto border rounded-lg bg-gray-40">
